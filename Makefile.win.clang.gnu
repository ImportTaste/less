...
ARCH_available := $(shell echo \#include ^<stdio.h^> > ${test_file_stem}.c && echo int main(void){printf("${test_file_stem}");return 0;} >> ${test_file_stem}.c && ${CC} ${CFLAGS} ${test_file_stem}.c -o ${test_file_stem})
# $(info ARCH=$(ARCH))
